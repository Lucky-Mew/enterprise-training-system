...
public class AdminController {
    ...
    @PostMapping("/add")
    public Result add(@RequestBody Admin admin){ // @RequestBody: 接收前端传来的json的参数
    ...
    public Result deleteBatch(@RequestBody List<Admin> list){  //@RequestBody: 接收前端传来的json的数组
        adminService.deleteBatch(list);
        return Result.success();
    }

    @PutMapping("/update")
    public Result update(@RequestBody Admin admin){ // @RequestBody: 接收前端传来的json的参数
